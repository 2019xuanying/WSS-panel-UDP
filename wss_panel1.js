 ...
 * V9.8.0 (Axiom Refactor V6.1 - TG Bot Integration)
 *
 * [AXIOM V9.8 CHANGELOG]
 * - [FEATURE] 集成 Telegram Bot 管理模块 (tg_bot_logic.js)。
...
try {
    ...
    console.log(`[AXIOM V5.7] 成功从 ${CONFIG_PATH} 加载配置。UDP Custom Port: ${config.udp_custom_port}`);
} catch (e) {
 ...
 * [AXIOM V5.7] 新增对 UDP Custom 端口修改的支持
 */
