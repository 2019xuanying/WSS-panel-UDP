/**
 * WSS Panel Frontend (Axiom Refactor V5.7 - UDP Custom UI Integration)
 *
...
// [AXIOM V5.7 FIX] 更新服务映射，包含新的 UDP Custom 服务
const CORE_SERVICES_MAP = {
    'wss': 'WSS Proxy',
    'stunnel4': 'Stunnel4',
    'udpgw': 'BadVPN UDPGW',
    'wss-udp-custom': 'UDP Custom', // [V5.7] Added
    'wss_panel': 'Web Panel'
};
